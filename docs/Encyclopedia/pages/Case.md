...
A case refers to a specific cancer patient or cell line in the context of a project<sup>1</sup>. In the GDC Data Model, cases are associated with a project, samples are collected from the case, and the clinical data<sup>2</sup>.
