...
4. Update all MAF files to in all_effects and VarScan2 indels. <!--DAT-987-->
5. Update VarScan VCF files <!--DAT-1020-->

Updated files for this release are listed [here](DR10.0_files_swap.txt.gz).
A complete list of files for DR9.0 are listed [here](gdc_manifest_20171024_data_release_10.0_active.txt.gz).
