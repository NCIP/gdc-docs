...
The [GDC gene fusion pipeline]('https://github.com/NCI-GDC/star_fusion_cwl/blob/master/cwl/tools/star_fusion.cwl') uses the STAR-Fusion v1.6 algorithm to generate gene fusion data.
